...
exports.Axios = Axios;
},{"./lib/axios.js":"../node_modules/axios/lib/axios.js"}],"src/models/Student.ts":[function(require,module,exports) {
"use strict";
...
var Student = /** @class */function () {
  ...
  Student.prototype.get = function (propName) {
    return this.data[propName];
  };
  //This update will copy any data as a new data
  Student.prototype.set = function (update) {
    Object.assign(this.data, update);
  };
  Student.prototype.fetch = function () {
    var _this = this;
    axios_1.default.get("http://localhost:3000/students/".concat(this.get('id'))).then(function (response) {
  ...
  Student.prototype.save = function () {
    ...
    if ('id') {
      // put 
      axios_1.default.put("http://localhost:3000/students/".concat(id), this.data);
    } else {
      // post
      axios_1.default.post("http://localhost:3000/students", this.data);
    }
  };
  return Student;
}();
...
student.save();
},{"./models/Student":"src/models/Student.ts"}],"../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
